...
#define OPTION_MASK_ISA_AES (HOST_WIDE_INT_1 << 5)
#define MASK_ALIGN_DOUBLE (1 << 4)
#define MASK_NO_ALIGN_STRINGOPS (1 << 5)
#define OPTION_MASK_ANDROID (1 << 0)
#define OPTION_MASK_ISA_AVX (HOST_WIDE_INT_1 << 6)
#define OPTION_MASK_ISA_AVX2 (HOST_WIDE_INT_1 << 7)
#define MASK_AVX256_SPLIT_UNALIGNED_LOAD (1 << 6)
#define MASK_AVX256_SPLIT_UNALIGNED_STORE (1 << 7)
#define OPTION_MASK_ISA_BMI (HOST_WIDE_INT_1 << 8)
#define OPTION_MASK_ISA_BMI2 (HOST_WIDE_INT_1 << 9)
#define MASK_CLD (1 << 8)
#define OPTION_MASK_ISA_CRC32 (HOST_WIDE_INT_1 << 10)
#define OPTION_MASK_ISA_CX16 (HOST_WIDE_INT_1 << 11)
#define OPTION_MASK_ISA_F16C (HOST_WIDE_INT_1 << 12)
#define MASK_NO_FANCY_MATH_387 (1 << 9)
#define OPTION_MASK_ISA_FMA (HOST_WIDE_INT_1 << 13)
#define OPTION_MASK_ISA_FMA4 (HOST_WIDE_INT_1 << 14)
#define MASK_FLOAT_RETURNS (1 << 10)
#define OPTION_MASK_ISA_FSGSBASE (HOST_WIDE_INT_1 << 15)
...
#define OPTION_MASK_ISA_LWP (HOST_WIDE_INT_1 << 16)
#define OPTION_MASK_ISA_LZCNT (HOST_WIDE_INT_1 << 17)
#define OPTION_MASK_ISA_MMX (HOST_WIDE_INT_1 << 18)
#define OPTION_MASK_ISA_MOVBE (HOST_WIDE_INT_1 << 19)
#define MASK_MS_BITFIELD_LAYOUT (1 << 15)
#define MASK_NO_PUSH_ARGS (1 << 16)
#define MASK_NO_RED_ZONE (1 << 17)
#define OPTION_MASK_ISA_SSE4_1 (HOST_WIDE_INT_1 << 20)
#define MASK_OMIT_LEAF_FRAME_POINTER (1 << 18)
#define OPTION_MASK_ISA_PCLMUL (HOST_WIDE_INT_1 << 21)
#define OPTION_MASK_ISA_POPCNT (HOST_WIDE_INT_1 << 22)
#define MASK_PREFER_AVX128 (1 << 19)
#define OPTION_MASK_ISA_RDRND (HOST_WIDE_INT_1 << 23)
...
#define OPTION_MASK_ISA_SSSE3 (HOST_WIDE_INT_1 << 30)
#define MASK_STACK_PROBE (1 << 23)
#define OPTION_MASK_ISA_TBM (HOST_WIDE_INT_1 << 31)
#define MASK_TLS_DIRECT_SEG_REFS (1 << 24)
#define MASK_VECT8_RETURNS (1 << 25)
#define MASK_VZEROUPPER (1 << 26)
#define OPTION_MASK_ABI_X32 (HOST_WIDE_INT_1 << 32)
#define OPTION_MASK_ISA_XOP (HOST_WIDE_INT_1 << 33)
 #if defined(HOST_BITS_PER_WIDE_INT) && 34 >= HOST_BITS_PER_WIDE_INT
...
#define OPTION_ABI_64 ((ix86_isa_flags & OPTION_MASK_ABI_64) != 0)
...
#define OPTION_ABI_X32 ((ix86_isa_flags & OPTION_MASK_ABI_X32) != 0)
...
enum opt_code
{
  ...
  OPT_maddress_mode_ = 996,                  /* -maddress-mode= */
  OPT_maes = 997,                            /* -maes */
  ...
  OPT_mlong_double_64 = 1038,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1039,                /* -mlong-double-80 */
  OPT_mlwp = 1040,                           /* -mlwp */
  OPT_mlzcnt = 1041,                         /* -mlzcnt */
  OPT_mmmx = 1042,                           /* -mmmx */
  OPT_mmovbe = 1043,                         /* -mmovbe */
  OPT_mms_bitfields = 1044,                  /* -mms-bitfields */
  OPT_mno_align_stringops = 1045,            /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 1046,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1047,                  /* -mno-push-args */
  OPT_mno_red_zone = 1048,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1049,                       /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 1050,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1051,                          /* -mpc32 */
  OPT_mpc64 = 1052,                          /* -mpc64 */
  OPT_mpc80 = 1053,                          /* -mpc80 */
  OPT_mpclmul = 1054,                        /* -mpclmul */
  OPT_mpopcnt = 1055,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1056,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1057,     /* -mpreferred-stack-boundary= */
  OPT_mpush_args = 1058,                     /* -mpush-args */
  OPT_mrdrnd = 1059,                         /* -mrdrnd */
  OPT_mrecip = 1060,                         /* -mrecip */
  OPT_mrecip_ = 1061,                        /* -mrecip= */
  OPT_mred_zone = 1062,                      /* -mred-zone */
  OPT_mregparm_ = 1063,                      /* -mregparm= */
  OPT_mrtd = 1064,                           /* -mrtd */
  OPT_msahf = 1065,                          /* -msahf */
  OPT_msoft_float = 1066,                    /* -msoft-float */
  OPT_msse = 1067,                           /* -msse */
  OPT_msse2 = 1068,                          /* -msse2 */
  OPT_msse2avx = 1069,                       /* -msse2avx */
  OPT_msse3 = 1070,                          /* -msse3 */
  OPT_msse4 = 1071,                          /* -msse4 */
  OPT_msse4_1 = 1072,                        /* -msse4.1 */
  OPT_msse4_2 = 1073,                        /* -msse4.2 */
  OPT_msse4a = 1074,                         /* -msse4a */
  /* OPT_msse5 = 1075, */                    /* -msse5 */
  OPT_msseregparm = 1076,                    /* -msseregparm */
  OPT_mssse3 = 1077,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1078,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1079,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1080,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1081,            /* -mstringop-strategy= */
  OPT_mtbm = 1082,                           /* -mtbm */
  OPT_mtls_dialect_ = 1083,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1084,           /* -mtls-direct-seg-refs */
  OPT_mtune_ = 1085,                         /* -mtune= */
  OPT_muclibc = 1086,                        /* -muclibc */
  OPT_mveclibabi_ = 1087,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1088,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1089,                    /* -mvzeroupper */
  OPT_mx32 = 1090,                           /* -mx32 */
  OPT_mxop = 1091,                           /* -mxop */
  OPT_n = 1092,                              /* -n */
  OPT_no_canonical_prefixes = 1093,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1094,              /* -no-integrated-cpp */
  OPT_nocpp = 1095,                          /* -nocpp */
  OPT_nodefaultlibs = 1096,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1097,                   /* -nostartfiles */
  OPT_nostdinc = 1098,                       /* -nostdinc */
  OPT_nostdinc__ = 1099,                     /* -nostdinc++ */
  OPT_nostdlib = 1100,                       /* -nostdlib */
  OPT_o = 1101,                              /* -o */
  OPT_p = 1102,                              /* -p */
  OPT_pass_exit_codes = 1103,                /* -pass-exit-codes */
  OPT_pedantic = 1104,                       /* -pedantic */
  OPT_pedantic_errors = 1105,                /* -pedantic-errors */
  OPT_pg = 1106,                             /* -pg */
  OPT_pie = 1107,                            /* -pie */
  OPT_pipe = 1108,                           /* -pipe */
  OPT_posix = 1109,                          /* -posix */
  OPT_print_file_name_ = 1110,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1111,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1112,          /* -print-multi-directory */
  OPT_print_multi_lib = 1113,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1114,       /* -print-multi-os-directory */
