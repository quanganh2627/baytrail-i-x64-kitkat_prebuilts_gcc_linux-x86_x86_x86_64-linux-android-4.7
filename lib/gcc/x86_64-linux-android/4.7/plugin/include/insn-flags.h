...
#define HAVE_trap 1
#define HAVE_stack_protect_set_si ((ix86_stack_protector_guard == SSP_TLS) && (ptr_mode == SImode))
#define HAVE_stack_protect_set_di ((ix86_stack_protector_guard == SSP_TLS) && (ptr_mode == DImode))
#define HAVE_stack_tls_protect_set_si (ptr_mode == SImode)
#define HAVE_stack_tls_protect_set_di (ptr_mode == DImode)
#define HAVE_stack_protect_test_si ((ix86_stack_protector_guard == SSP_TLS) && (ptr_mode == SImode))
#define HAVE_stack_protect_test_di ((ix86_stack_protector_guard == SSP_TLS) && (ptr_mode == DImode))
...
#define HAVE_stack_protect_set (ix86_stack_protector_guard == SSP_TLS)
#define HAVE_stack_protect_test (ix86_stack_protector_guard == SSP_TLS)
#define HAVE_rdpmc 1
#define HAVE_rdtsc 1
